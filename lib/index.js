...
function unmockConnect() {
    mongoose.connect = connect;
}
exports.unmockConnect = unmockConnect;
...
exports.mockCreateConnection = mockCreateConnection;
function unmockCreateConnection() {
    mongoose.createConnection = createConnection;
}
exports.unmockCreateConnection = unmockCreateConnection;
mockConnect();
...
exports.mockedMongoose = null; // mongoose
